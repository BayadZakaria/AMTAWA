      ...
      <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 mb-6">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            {/* Scans Tab */}
            {activeTab === 'scans' && (
              (historyData?.scans?.length || 0) > 0 ? historyData.scans.map((scan: any, i: number) => (
            ...
            {/* Meals Tab */}
            {activeTab === 'meals' && (
              (historyData?.meals?.length || 0) > 0 ? historyData.meals.map((meal: any, i: number) => (
            ...
            {/* Fitness Tab */}
            {activeTab === 'fitness' && (
              (historyData?.fitness?.length || 0) > 0 ? historyData.fitness.map((plan: any, i: number) => (
                <div key={i} className="p-5 border border-slate-100 rounded-2xl bg-slate-50/50">
                  <div className="flex justify-between items-center mb-4">
