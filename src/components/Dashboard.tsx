...
import { Activity, Wallet, AlertCircle, Download } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="bg-gradient-to-br from-purple-700 to-purple-900 rounded-[2.5rem] p-8 shadow-xl text-white mb-6 relative overflow-hidden">
        ...
        <div className="relative z-10">
           ...
           <p className="text-purple-200 text-lg mb-6">Voici un aperçu de votre profil de santé intelligent.</p>
           
           {isInstallable && (
             <button 
               onClick={installPWA}
               className="bg-white text-purple-700 hover:bg-purple-50 font-bold py-3 px-6 rounded-xl shadow-lg transition-all flex items-center gap-2"
             >
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 hover:shadow-md transition">
          ...
          <div className="space-y-4">
            <div>
              ...
              {(medicalProfile?.allergies?.length || 0) > 0 ? (
            ...
            <div>
              ...
              {(medicalProfile?.conditions?.length || 0) > 0 ? (
                <div className="flex flex-wrap gap-2">
