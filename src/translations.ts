...
export const translations = {
  en: {
    ...
    analyseExpert: "Expert Analysis",
    safeProfile: "Safe for your profile",
    safeDesc: "No conflicting allergens detected.",
    warningMatch: "WARNING! Allergen Match",
  ...
  fr: {
    ...
    analyseExpert: "Analyse Expert",
    safeProfile: "Sûr pour votre profil",
    safeDesc: "Aucun allergène conflictuel détecté.",
    warningMatch: "ATTENTION ! Correspondance d'allergène",
  ...
  ar: {
    ...
    analyseExpert: "تحليل خبير",
    safeProfile: "آمن لملفك الشخصي",
    safeDesc: "لم يتم اكتشاف أي مسببات حساسية.",
    warningMatch: "تحذير! تطابق مُسبب حساسية",
  ...
  zgh: {
    ...
    analyseExpert: "ⴰⵙⴼⵙⵉ ⵏ ⵓⵎⵓⵣⴰⵢ",
    safeProfile: "ⵉⵖⵓⴷⴰ ⵉ ⵡⴰⴷⴷⴰⴷ ⵏⵏⴽ",
    safeDesc: "ⵓⵔ ⵉⵍⵍⵉ ⵎⴰⵢⴷ ⵉⵜⵜⵓⵙⴽⴰⵔⵏ.",
    warningMatch: "ⴰⵖⵓⵔⵔⵉ! ⵜⵉⵏⴰⵖⵉⵏ ⵏ ⵜⴰⴷⵓⵙⵉ",
